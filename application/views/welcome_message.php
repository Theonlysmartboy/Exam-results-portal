...
<html lang="en">
    ...
    <body>
        <div id="container">
            ...
            <div id="body">
                <div class="navbar navbar-inverse navbar-static-top my-navbar" data-spy="affix" data-offset-top="197" style="background-color: #006633; width: 100%; margin-top: -3.2px; padding: 0;">
                    <div class="container-fluid">
                        <a href="http://www.maseno.ac.ke" class="navbar-brand">Online Resul ts </a>
            ...
            <div class="rows">
                <div class="col-md-2">
                    <p><b>Welcome to the exam results portal</b></p><p>
                        This system allows you to view your results and fee balance.
            ...
            <div class="footer">
                <p class="myfooter">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo (ENVIRONMENT === 'development') ? 'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
            </div>
        </div>
    </body>
</html>